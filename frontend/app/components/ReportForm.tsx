...
export default function ReportForm() {
    ...
    if (success) {
        return (
            <div className="bg-emerald-50 text-emerald-800 p-8 rounded-2xl shadow-sm text-center border border-emerald-200">
                <h3 className="text-2xl font-bold mb-2">Report Submitted Successfully!</h3>
                <p className="mb-6">Thank you for helping restore the Earth. AI is analyzing your report.</p>
                <button onClick={() => { setSuccess(false); setLocation(null); }} className="bg-emerald-600 text-white px-6 py-2 rounded-full font-medium hover:bg-emerald-700">Submit Another</button>
            </div>
        );
    }
